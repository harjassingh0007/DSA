...
void test_17_check_all_the_brackets_when_match_found(){
	char* string = "{hello(friends)how are[you]}";
	int result;
	result = matchBraces(string);
	ASSERT(1 == result);
}

void test_18_check_all_the_brackets_when_match_not_found(){
	char* string = "{hello(friendshow are[you}";
	int result;
	result = matchBraces(string);
	ASSERT(0 == result);
}
